function plotPC_codechanging(N,K,channelstring,channelstate_range,MaxIterations) % last argument is optional
%   This is exactly the same as plotPC(), except for a
...
% 
%       1. Re-constructing the code at every state of the channel
...
%   ====================================================================
%    Usage: plotPC_codechanging(N,K,channelstring,design_channelstate,channelstate_range,MaxIterations)
%
%       N             -  Block length
%       K             -  Message length
% 
...
global BER;
global FER;
global channel_param_range;

channel_param_range=chrange;
...
for jj=1:length(chrange)
 ...
 titlestr = sprintf('N=%d R=%.2f Polar code performance (reconstructed everytime)',N,(K/N));
