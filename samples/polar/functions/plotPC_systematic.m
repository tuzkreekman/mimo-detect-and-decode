function plotPC_systematic(N,K,channelstring,design_channelstate,channelstate_range,MaxIterations) % last argument optional
% Plot the performance (FER/BER) curve for (N,K) "systematic" polar code, by 
% 
...
% =======================================================================
%    Usage: plotPC_systematic(N,K,channelstring,design_channelstate,channelstate_range,MaxIterations)
%
%            N        -  Block length
%            K        -  Message length
% 
...
initPC(N,K,channelstring,design_channelstate,1); %last optional argument '1' says "be silent" with no output at prompt.
...
for jj=1:length(chrange)
 ...
 titlestr = sprintf('N=%d R=%.2f Systematic Polar code performance (design-%s=%.2e)',N,(K/N),paramstr,design_channelstate);
